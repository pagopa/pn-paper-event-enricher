...
class Con020ArchiveDaoIT extends BaseTest.WithLocalStack {
    ...
    private static CON020ArchiveEntity createArchiveEntity(String hashKey, String sortKey) {
    ...
    void putIfAbsentAndUpdateIfExist_testOK() {
        ...
        CON020ArchiveEntity con020ArchiveEntity = createArchiveEntity(hashKey, "sortKey");
    ...
    void putIfAbsentAndUpdateIfExist_updateKO_itemDoesNotExists() {
        ...
        Assertions.assertThrows(PaperEventEnricherException.class,
                () -> con020ArchiveDao.updateIfExists(con020ArchiveEntity).block(),
